"""
Script para automatizar la devolución de una compra de fracciones sin cliente, incluyendo logs y guardando los datos en una variable.
"""
import time
import os
import logging
...
from venta_fraccion_sincliente import venta_fracciones_sin_cliente_info
...
def fraccion_venta_sincliente(driver):
    """
    ...
    try:
        ...
        print(f"Devolución completada para factura: {factura}, Caja: {venta_fracciones_sin_cliente_info.get('numero_caja', 'No capturado')}, Causal: {venta_fracciones_sin_cliente_info.get('causal', 'No capturada')}")
