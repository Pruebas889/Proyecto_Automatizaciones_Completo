...
from cajero_ventas import venta_cliente_info
...
def ingresar_numero_factura(driver, wait, capturas, textos, nombre_automatizacion):
    try:
        factura = venta_cliente_info.get("factura")
        if not factura:
...
def ingresar_numero_caja(driver, wait, capturas, textos, nombre_automatizacion):
    ...
    try:
        ...
        venta_cliente_info["numero_caja"] = numero_caja_asignada
...
def seleccionar_causal_devolucion(driver, wait, capturas, textos, nombre_automatizacion, indice_causal=3):
    try:
        ...
        venta_cliente_info["causal"] = causal_texto
...
def confirmar_devolucion_final(driver, wait, capturas, textos, nombre_automatizacion):
    try:
        ...
        venta_cliente_info["estado"] = "completado"
...
def devolucion_factura(driver):
    ...
    capturas = []
    textos = []
    nombre_automatizacion = "devolucion_ventas_pdf"
    ...
    try:
        ...
        mostrar_mensaje(driver, "Se efectuará la devolución de la compra con cliente", nombre_automatizacion)
        ...
        print(f"Devolución completada para factura: {factura}, Caja: {venta_cliente_info.get('numero_caja', 'No capturado')}, Causal: {venta_cliente_info.get('causal', 'No capturada')}")
